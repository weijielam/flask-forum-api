...
class ForumTestCase(unittest.TestCase):
    ...
    def test_a_02_create_category(self):
        response = self.client() \
            .post('/categories', json=self.VALID_NEW_CATEGORY)
        data = json.loads(response.data)
    ...
    def test_a_03_create_category_422(self):
        response = self.client() \
            .post('/categories', json=self.INVALID_NEW_CATEGORY)
        data = json.loads(response.data)
    ...
    def test_a_04_create_post(self):
        response = self.client() \
            .post('/posts', json=self.VALID_NEW_POST)
        data = json.loads(response.data)
    ...
    def test_a_05_create_post_422(self):
        response = self.client() \
            .post('/posts', json=self.INVALID_NEW_POST)
        data = json.loads(response.data)
    ...
    def test_a_06_create_comment(self):
        response = self.client() \
            .post('/comments', json=self.VALID_NEW_COMMENT)
        data = json.loads(response.data)
    ...
    def test_a_07_create_comment_422(self):
        response = self.client() \
            .post('/comments', json=self.INVALID_NEW_COMMENT)
        data = json.loads(response.data)
    ...
    def test_c_01_update_category(self):
        response = self.client() \
            .patch('/categories/1', json=self.VALID_UPDATE_CATEGORY)
        data = json.loads(response.data)

        self.assertEqual(response.status_code, 200)
        self.assertTrue(data["success"])
        self.assertIn('category', data)
        self.assertEqual(data["category"]["description"],
                         self.VALID_UPDATE_CATEGORY["description"])

    def test_c_02_update_category_404(self):
        response = self.client() \
            .patch('/categories/100', json=self.INVALID_UPDATE_CATEGORY)
        data = json.loads(response.data)
    ...
    def test_d_01_delete_comment_on_post(self):
        response = self.client() \
            .delete('/comments', json=self.VALID_DELETE_COMMENT)
        data = json.loads(response.data)
